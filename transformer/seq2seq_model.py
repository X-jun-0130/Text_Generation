...
class Transformer(tf.keras.Model):
    def __init__(self,
        ...
        self.embedding_dropout = tf.keras.layers.Dropout(dropout_prob)
    ...
    def call(self,
        ...
        encoder_tensor = self.embedding_layer(inputs)
        encoder_tensor = self.embedding_dropout(encoder_tensor, training=training)
        ...
        decoder_tensor = self.embedding_dropout(target, training=training)
